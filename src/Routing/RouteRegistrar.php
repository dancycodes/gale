 ...
 * pipeline defined in gale.route_discovery.pending_route_transformers configuration.
 *
 ...
 * @see \Dancycodes\Gale\Routing\PendingRoutes\PendingRouteFactory
 * @see \Dancycodes\Gale\Routing\PendingRouteTransformers\PendingRouteTransformer
 */
class RouteRegistrar
{
    ...
    protected function transformPendingRoutes(Collection $pendingRoutes): Collection
    {
        ...
        $transformers = config('gale.route_discovery.pending_route_transformers');

 ...
 * @see \Dancycodes\Gale\Routing\PendingRouteTransformers\HandleHttpMethodsAttribute
 * @see \Dancycodes\Gale\Routing\PendingRouteTransformers\HandleUriAttribute
 */

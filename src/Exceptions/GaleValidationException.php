 ...
 *
 * @see \Dancycodes\Gale\Http\GaleSignal::validate()
 */
class GaleValidationException extends ValidationException
{
    /**
     ...
     *
     * @return \Dancycodes\Gale\Http\GaleResponse Reactive response with errors signal
     */

...
namespace Dancycodes\Gale\Tests\Unit\Validation;

use Dancycodes\Gale\Tests\TestCase;
use Dancycodes\Gale\Validation\GaleBase64Validator;
use Illuminate\Support\Facades\Validator as ValidatorFacade;

/**
 * Test the GaleBase64Validator class
 *
 * @see TESTING.md - File 10: GaleBase64Validator Tests
 * Status: 🔄 IN PROGRESS - 40 test methods
 */
class GaleBase64ValidatorTest extends TestCase
{
    public static $latestResponse;

    protected GaleBase64Validator $validator;
    ...
    {
        parent::setUp();
        $this->validator = new GaleBase64Validator;
    }

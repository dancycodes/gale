...
namespace Dancycodes\Gale\Tests\Unit\Services;
...
/**
 * Test the GaleUrlManager service
 *
 * @see TESTING.md - File 6: GaleUrlManager Tests
 * Status: 🔄 IN PROGRESS - 20 test methods
 */
class GaleUrlManagerTest extends TestCase
{
    public static $latestResponse;

    protected GaleUrlManager $urlManager;

    protected function setUp(): void
    {
        parent::setUp();
        $this->urlManager = app(GaleUrlManager::class);
    }
